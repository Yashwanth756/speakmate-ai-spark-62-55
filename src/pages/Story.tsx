          ...
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-green-600 mb-4">
                Great job! You've successfully completed this story assignment.
              </p>
              <Link to="/student/dashboard">
                <Button>
                  <ArrowLeft className="h-4 w-4 mr-2" />
    ...
    <div className="container mx-auto p-6 max-w-4xl">
      {isAssignmentMode && assignment && (
        <Card className="mb-6 border-blue-200 bg-blue-50">
          <CardHeader>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-blue-800">Assignment: {assignment.title}</CardTitle>
          ...
          <CardContent>
            <p className="text-blue-700 mb-4">{assignment.content}</p>
